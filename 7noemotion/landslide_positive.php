        ...
        <div class="row">
            <div class="jumbotron">
                ...
                if($_SESSION['message_fatality'])
                {
                  ...
                  // echo "<p>Your daily income has decreased to "; echo "<strong>"; echo round($_SESSION['daily_income'],1); echo "</strong>.</p>";
...
//echo "<p>Fortunately, no one in your family died.</p>";echo "<p>Thus, your daily income was not affected and stays at the same value.</p>";
...
echo "<p>Your daily income is "; echo "<strong>"; echo round($_SESSION['daily_income'],1); echo "</strong>.</p>";
//echo "<p>Fortunately, no one in your family was injured.</p>"; echo "<p>Thus, your daily income was not affected and stays at the same value.</p>";
}
            ...
            <?php    if($_SESSION['message_property'])
             ...
             ?>
<p>Your property wealth is decreased to <strong><?php echo round($_SESSION['final_money_array'][$_SESSION['day']-1],1) ;?></strong>.</p>
 <?php  }
...
echo "<p>Your property wealth is <strong>"; echo round($_SESSION['final_money_array'][$_SESSION['day']-1],1) ;echo "</strong>.</p></p>";
}
                ?>
