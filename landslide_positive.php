    ...
    <div class="container-fluid">
        <div class="row">
            <div class="jumbotron">
                ...
                <?php if (isset($_SESSION['nbr_pay']) && ($_SESSION['version']==1 || $_SESSION['version']==2 || $_SESSION['version']==3)) { ?>
                    <p><strong>Your friend invested: <?php echo $_SESSION['nbr_pay']; ?> </strong></p>
                <?php }
                ?>
                <?php
                if ($_SESSION['message_fatality']) {
                    echo "<p>Sorry, a wage-earner of your family got buried under the debris of the mudslide. Thus, your daily income was affected and decreased to ";
                    echo "<strong>";
                    echo round($_SESSION['daily_income'], 1);
                    echo "</strong>.</p>";
                } else {
                    echo "<p>Fortunately, no one in your family died.</p>";
                    echo "<p>Thus, your daily income was not affected and stays at the same value.</p>";
                }
                if ($_SESSION['message_injury']) {
                    echo "<p>Sorry, a wage-earner of your family got injured in a car accident while traveling with a friend. Thus, your daily income was affected and decreased to ";
                    echo "<strong>";
                    echo round($_SESSION['daily_income'], 1);
                    echo "</strong>.</p>";
                } else {
                    echo "<p>Fortunately, no one in your family was injured.</p>";
                    echo "<p>Thus, your daily income was not affected and stays at the same value.</p>";
                }   ?>


                <?php if ($_SESSION['message_property']) {
                    echo "<p>Sorry, your house was destroyed by the debris. Total damage occurred is ";
                    echo "<strong>";
                ...
                <br>
                <?php if ($_SESSION['day'] - 1 == $_SESSION['time_span']) {
                    echo "<a href='end.php'><button class='btn btn-warning'>Return To Game</button></a>";
                } else {
                ...
                <div class="row">
                    ...
                    $conn1 = new mysqli("localhost", "u978805288_user", "password", "u978805288_acs_draft");
                    ...
                    if ($_SESSION['message_fatality']) {
                        ...
                        if ($resultdth = mysqli_query($conn1, $sqldth)) {
                            ...
                            echo "<div class='col-md-4'><embed height='400' width='100%' src='";
                            echo $dth_img_src;
                            echo "'></div>";
                        }
                    }
