        ...
        <body>
            ...
            <div class="container">
                ...
                <div class="jumbotron">
                    ...
                    <p>If a death occurs, your daily income will be reduced by <strong><?php $fat_loss = 100 * $_SESSION['fatality_daily_inc_loss'];
                                                                                        echo  $fat_loss; ?></strong>% of its current value.</p>
                    <p>If an injury takes place, your daily income will be reduced by <strong><?php $inj_loss = 100 * $_SESSION['injury_daily_inc_loss'];
