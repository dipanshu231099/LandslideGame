...
if (!isset($_GET['id']) && empty($_GET['id'])) { ?>
    ...
    <body>
        <div class="container">
            <h1>OOPS!</h1><br>
            <h3>Please go <a href="index2.php">here</a> first</h3>
        </div>
    </body>

    </html>

<?php   } elseif (!isset($_GET['connect']) && empty($_GET['connect'])) {
?>
...
<?php } elseif (empty($_SESSION['consent'])) {
?>
    ...
    <body>
        <div class="alert alert-danger">
            ...
            <h3>Please click <a href="index.php">here</a></h3>.
        </div>
    </body>
            ...
            <div class="jumbotron">
                ...
                <form role="form" method="POST" id="form1" name="form1" action="instruction.php?id=<?= isset($_GET['id']) ? $_GET['id'] : '' ?>&connect=true&demo=true">
                    ...
                    <div class="form-group containerx">
                        <label>Age:</label>
                        <input type="number" class="form-control" value="18" id="age" name="age" max=100 min=<?php echo $_SESSION['age_restriction']; ?> required>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="major" name="major" placeholder="Specialisation" required>
                    </div>
...
<div class="form-group">
        ...
        <input type="text" class="form-control" id="ownerother" name="ownerother">
                    ...
                    <div class="form-group">
                        ...
                        <button type='submit' id='validate' class="btn btn-primary btn-lg" name="Submit">Proceed</button>
                </form>
            </div>
            <script>
