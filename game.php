...
?>
    ...
    <body>
        <div class="container">
            <h1>OOPS!</h1><br>
            <h3>Please go <a href="index.php">here</a> first</h3>
        </div>
    </body>
...
?>
    ...
    <body>
        <div class="container">
            <h1>OOPS!</h1><br>
            <h3>Please go <a href="connect.php">here</a> first</h3>
        </div>
    </body>
                    ...
                    <div class="well">
                        ...
                        <table class="table table-hover table-condensed">
                            ...
                            <tr class="info">
                                ...
                                <th><?php $income = floor($_SESSION['daily_income'] * 10) / 10;
                                    echo $income;
                                    ?></th>
                            </tr>
                            <!--          <tr class="info">
                            ...
                            <tr class="info">
                                ...
                                <th><?php
                                    if ($_SESSION['day'] == 1) {
                                        ...
                                        $unqid = $_SESSION['uid'];
                                        $td = 0;
                                        $sqltd = "SELECT SUM(damage) from $game where id='$unqid';";
    ...
    $(function() {
        $('#container1').highcharts({
            ...
            series: [{
                name: '<?php echo ' '; ?>',
                data: <?php echo "[";
                        $count = count($_SESSION['final_money_array']);
                        $j = 0;
                        for ($j = 0; $j < $count - 1; $j++) {
                            echo $_SESSION['final_money_array'][$j];
                            echo ",";
                        };
                        echo $_SESSION['final_money_array'][$count - 1];
                        echo "]";
    ...
    $(function() {
        $('#container3').highcharts({
            ...
            series: [{
                name: '<?php echo ' '; ?>',
                data: <?php echo "[";
                        $count = count($_SESSION['p_landslide_array']);
                        $j = 0;
                        for ($j = 0; $j < $count - 1; $j++) {
                            echo $_SESSION['p_landslide_array'][$j];
                            echo ",";
                        };
                        echo $_SESSION['p_landslide_array'][$count - 1];
                        echo "]";
                        ?>
            }]
        });
    ...
    $(function() {
        $('#container4').highcharts({
            ...
            series: [{
                name: '<?php echo ' '; ?>',
                data: <?php echo "[";
                        $count = count($_SESSION['income_not_invested']);
                        $j = 0;
                        for ($j = 0; $j < $count - 1; $j++) {
                            echo $_SESSION['income_not_invested'][$j];
                            echo ",";
                        };
                        echo $_SESSION['income_not_invested'][$count - 1];
                        echo "]";
                        ?>
            }]
        });
