    ...
    <div class="container-fluid">
        <div class="row">
            <div class="jumbotron">
                ...
                <p>Your income is <strong><?php echo round($_SESSION['daily_income'],1);?></strong>.</p>
            
                <p>Your property wealth is <strong><?php echo $_SESSION['final_money_array'][$_SESSION['day']-1] ;?></strong>.</p>
