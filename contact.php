...
<div class=\"container-fluid\">
    ...
    <strong>Thanks ";
        echo $_SESSION['akshit'];
        echo "!</strong></h2>. <p>Your message has been delivered.</p>
    </div></div>
";
    }
    session_destroy();
    ...
    <div class="container-fluid">
        <div class="jumbotron">
            <h1 class="text-center"><i class="fa fa-users"></i> The Team</h1>
        </div>
        <div class="row">
            <div class="col-md-3">
                <blockquote>
                    ...
                    <a href="http://faculty.iitmandi.ac.in/~varun/">
                        <h3><b>Dr. Varun Dutt</b></h3>
                    </a><br>
            ...
            <div class="col-md-3">
                <blockquote>
                    ...
                    <a href="https://www.facebook.com/ayushman.dixit.7">
                        <h3><b>Mr. Ayushman Dixit</b></h3>
                    </a><br>
            ...
            <div class="col-md-3">
                <blockquote>
                    <h4 class="kalam">Website Developer:</h4><br>
                    <embed src="dipanshu.jpg" height="150" width="150">

                    <a href="https://www.facebook.com/dipanshu231099">
                        <h3><b>Mr. Dipanshu Verma</b></h3>
                    </a><br>
                    <i class="fa fa-user"></i> B.Tech Student<br>
                    <a href="http://www.acslab.org/"><i class="fa fa-plus-square"></i> Computer Science Engineering</a><br>
                    <a href="http://www.iitmandi.ac.in"><i class="fa fa-external-link"></i>Indian Institute of Technology, Mandi</a><br>
            ...
            <div class="col-md-3">
                <blockquote>
                    ...
                    <a href="https://in.linkedin.com/in/akshitarora1995">
                        <h3><b>Akshit Arora</b></h3>
                    </a><br>
